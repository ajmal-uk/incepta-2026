...
function ObscuraRegistrationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('success', 'Registration successful! Redirecting to WhatsApp group...');
      setTimeout(() => {
        window.location.href = WHATSAPP_GROUP_LINK;
      }, 1200);
      setForm({ name: '', college: '', phone: '' });
    } catch (err) {
  ...
  return (
    <section className="section">
      ...
      <div className="contact-form" style={{ maxWidth: 400, margin: "40px auto", padding: 24, borderRadius: 8, boxShadow: "0 2px 8px #eee" }}>
        <h2 className="section-title">OBSCURA Registration</h2>
...
export default ObscuraRegistrationPage;
